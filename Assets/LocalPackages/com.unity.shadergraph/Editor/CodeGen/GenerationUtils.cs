...
namespace UnityEditor.ShaderGraph
{
    static class GenerationUtils
    {
            ...
            List<Dependency[]> dependencies, string resourceClassName, string assemblyName)
        {
            ...
            string templatePath = "Assets/LocalPackages/com.unity.render-pipelines.universal/Editor/ShaderGraph/Templates";
        ...
        {
            var basePath = "LocalPackages/com.unity.shadergraph/Editor/Templates/";

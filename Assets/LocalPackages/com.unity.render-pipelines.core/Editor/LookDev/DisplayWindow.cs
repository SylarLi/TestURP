...
namespace UnityEditor.Rendering.LookDev
{
    ...
    partial class DisplayWindow : EditorWindow, IViewDisplayer
    {
        ...
        {
            internal const string k_IconFolder = @"Assets/LocalPackages/com.unity.render-pipelines.core/Editor/LookDev/Icons/";
            internal const string k_uss = @"Assets/LocalPackages/com.unity.render-pipelines.core/Editor/LookDev/DisplayWindow.uss";
            internal const string k_uss_personal_overload = @"Assets/LocalPackages/com.unity.render-pipelines.core/Editor/LookDev/DisplayWindow-PersonalSkin.uss";

...
namespace UnityEditor.Rendering.LookDev
{
    ...
    class EnvironmentElement : VisualElement, IBendable<Environment>
    {
        ...
        public VisualElement GetDefaultInspector()
        {
            ...
            {
                image = CoreEditorUtils.LoadIcon(@"Assets/LocalPackages/com.unity.render-pipelines.core/Editor/LookDev/Icons/", "Environment", forceLowRes: true)
            });
            ...
            {
                image = CoreEditorUtils.LoadIcon(@"Assets/LocalPackages/com.unity.render-pipelines.core/Editor/LookDev/Icons/", "SunPosition", forceLowRes: true)
            });

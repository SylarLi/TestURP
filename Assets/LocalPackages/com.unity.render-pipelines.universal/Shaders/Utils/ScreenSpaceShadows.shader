Shader "Hidden/Universal Render Pipeline/ScreenSpaceShadows"
{
    SubShader
    {
        ...
        #include "Assets/LocalPackages/com.unity.render-pipelines.core/ShaderLibrary/EntityLighting.hlsl"
        #include "Assets/LocalPackages/com.unity.render-pipelines.core/ShaderLibrary/ImageBasedLighting.hlsl"
        #include "Assets/LocalPackages/com.unity.render-pipelines.universal/ShaderLibrary/Core.hlsl"
        #include "Assets/LocalPackages/com.unity.render-pipelines.universal/ShaderLibrary/Shadows.hlsl"
        #include "Assets/LocalPackages/com.unity.render-pipelines.universal/ShaderLibrary/DeclareDepthTexture.hlsl"

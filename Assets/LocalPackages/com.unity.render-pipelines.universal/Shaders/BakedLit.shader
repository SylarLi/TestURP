Shader "Universal Render Pipeline/Baked Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/LocalPackages/com.unity.render-pipelines.universal/ShaderLibrary/Lighting.hlsl"
            #include "Assets/LocalPackages/com.unity.render-pipelines.universal/Shaders/BakedLitInput.hlsl"
        ...
        Pass
        {
            ...
            #include "Assets/LocalPackages/com.unity.render-pipelines.universal/Shaders/BakedLitInput.hlsl"
            #include "Assets/LocalPackages/com.unity.render-pipelines.universal/Shaders/BakedLitMetaPass.hlsl"

...
namespace UnityEditor.Rendering.Universal
{
    ...
    public class PostProcessDataEditor : Editor
    {
        ...
        SerializedProperty m_TransparentOverlay;

        private void OnEnable()
        {
            m_Shaders = serializedObject.FindProperty("shaders");
            m_Textures = serializedObject.FindProperty("textures");
            m_TransparentOverlay = serializedObject.FindProperty("m_TransparentOverlay");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_TransparentOverlay,
                new GUIContent("Transparent Overlay", "Is Support transparent overlay of camera. (valid effect: Bloom.)"));
